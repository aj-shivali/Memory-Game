class memoryGame {
  ...
  highScore(victoryScore) {
    if (!localStorage.getItem("clicks")) {
      localStorage.setItem("clicks", this.totalClicks);
    }
    let temp = localStorage.getItem("clicks");
    if (this.totalClicks <= temp) {
      localStorage.setItem("High Score", this.victoryScore);
      localStorage.setItem("clicks", this.totalClicks);
      this.high = localStorage.getItem("clicks");
