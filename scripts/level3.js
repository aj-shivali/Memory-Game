class memoryGame {
  ...
  highScore(victoryScore) {
    if (!localStorage.getItem("level3-clicks")) {
      localStorage.setItem("level3-clicks", this.totalClicks);
    }
    let temp = localStorage.getItem("level3-clicks");
    if (this.totalClicks <= temp) {
      localStorage.setItem("High Score-3", this.victoryScore);
      localStorage.setItem("level3-clicks", this.totalClicks);
      this.high = localStorage.getItem("level3-clicks");
